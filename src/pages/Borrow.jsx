  ...
  return (
    <main className="ml-52 pt-20 px-6 pb-6 min-h-screen bg-slate-50 dark:bg-slate-950 transition-colors dark:text-slate-400">
      ...
      <div className="max-w-6xl mx-auto flex flex-col gap-6">
        ...
        {/* FORM CARD */}
        <div className="bg-white dark:bg-slate-900 rounded-xl shadow p-6 dark:text-slate-400">

          <form className="grid grid-cols-1 md:grid-cols-2 gap-4">

            {/* PERSON */}
            <Input label="Borrowed From" icon={<MdPerson />} placeholder="Name" />

            {/* AMOUNT */}
            <Input label="Amount" icon={<MdAttachMoney />} placeholder="0.00" type="number" />
