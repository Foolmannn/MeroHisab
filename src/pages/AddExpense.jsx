          ...
          <div className="bg-white dark:bg-slate-900 rounded-xl shadow p-4 ">
            ...
            <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
              ...
              <div className="flex justify-between items-center p-2 bg-emerald-50 dark:bg-emerald-900/20 rounded-lg">
                ...
                <input type="checkbox" className="cursor-pointer w-4 h-5 accent-emerald-500" />
              </div>

              {/* BUTTONS */}
              <div className="flex gap-3 mt-1">
                <button type="submit" className="flex-1 h-11 bg-emerald-500 text-white rounded-full font-semibold flex items-center justify-center gap-2 hover:bg-emerald-600 transition active:scale-95">
                  <MdCheckCircle />
                  Save
                </button>
                <button type="button" className="px-6 h-11 bg-slate-200 dark:bg-slate-700 rounded-full hover:bg-slate-300 dark:hover:bg-slate-600 transition">
                  Cancel
                </button>
              </div>
            </form>
